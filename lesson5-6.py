...
print(
    "Hello World", "python", 2 + 2, sep="-"
)  # sep="" - сепаратор между слов можно знак вместо пробела
print(
    "Hello World", "python", 2 + 2, end="<"
)  # end="" - в конце ставит знак, после него нового рядка не будет
