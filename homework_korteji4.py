...
def workers(in_office, out_office):
    ...
    print(f"Відсоток працівників, які працюють і в офісі, і віддалено: {in_out_rate:.1%}")

office_workers = {
    "anna", "ivan", "olga", "maksym", "iryna", "dmytro", "taras"
}

remote_workers = {
    "olga", "maksym", "iryna", "andrii", "sofia", "taras", "nazar"
}
