...
person1 = ["Молоко", "Хліб", "Яйця", "Сир", "Масло", "Яблука", "Кава", "Хліб"]

person2 = ["Хліб", "Яйця", "Чай", "Цукор", "Молоко", "Банани", "Кава", "Чай"]
...
def conference_guests(registered_ls, payed_ls, confirmed_ls):
    ...
    print(
        f"Імена тих, хто підтвердив присутність, але не  зареєстрований {conf_noreg_guests}"
    )

    payed_noconf_guests = payed_guests.difference(confirmed_guests)
    print(
        f"Імена тих, хто оплатив участь, але не підтвердив присутність {payed_noconf_guests}"
    )
...
paid = ["Марія", "Олег", "Ірина", "Тарас", "Софія", "Оксана", "Олег", "Ірина"]

confirmed = ["Марія", "Софія", "Дмитро", "Андрій", "Оксана", "Юлія", "Марія"]
...
group1 = ["Андрій", "Марія", "Олег", "Ірина"]

group2 = ["Софія", "Дмитро", "Наталія", "Олег"]

group3 = ["Владислав", "Оксана"]
