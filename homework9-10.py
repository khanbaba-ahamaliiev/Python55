...
question = int(input("""Виберіть один из вариантів(1, 2, 3):
...
"""))
if question == 1:
    question1 = int(input("""виберіть(1, 2, 3): 
    1. милі
    2. дюйми
    3. ярди """))
    if question1 == 1:
...
operation = int(input("Bибeріть операцію (1-6) 1. додавання, 2. віднімання, 3. множення, 4. ділення, 5. знаходження залишку, 6. піднесення до степеня: "))
if operation == 1:
