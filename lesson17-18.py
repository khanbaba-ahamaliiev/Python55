...
# trim
print("    Hello wOrLd    ".lower().strip()) # - можно подряд несколько методов использовать
print("   hello world   ".strip()) # -убирает пробелы по краям

print("   hello world   ?@#".strip("?@#")) # - если в скобки добавить символы то оно убирает символы по бокам
...
print("banana".startswith("na")) # true of false начинается ли строка из того что в скобках
...
age = 19
print(f"{name} hi!")
print("{0} hi!, age {1}".format(name, age))
